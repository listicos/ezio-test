...
/**
   The maximum length of Challenge Question for a C/R operation. Allowed values are 6 or 8
   digits.
  
   @see [EMGemaltoOathDevice ocraTimeChallengeResponseWithAuthInput:challengeQuestion:error:]
   @see [EMGemaltoOathDevice ocraEventChallengeResponseWithAuthInput:challengeQuestion:error:]
