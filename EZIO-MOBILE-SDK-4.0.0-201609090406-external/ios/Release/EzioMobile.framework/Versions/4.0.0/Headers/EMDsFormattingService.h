 ...
 * Returns the EMDsFormattingService object created using the EMOtpModule
 *
 * @param module an instance of EMOtpModule
 * @return EMDsFormattingService module instance.
 *
 * @since 4.0
 */
+ (EMDsFormattingService *)serviceWithModule:(EMOtpModule *)module;

/**
 * Returns Factory for creating VIC settings and VIC devices.
 *
 * @return EMDsFormattingFactory object.
 */
