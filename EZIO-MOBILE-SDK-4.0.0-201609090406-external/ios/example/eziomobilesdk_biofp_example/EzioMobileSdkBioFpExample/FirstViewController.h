...
@property (weak, nonatomic) IBOutlet UIButton *btnGetOTPUsingPIN;
@property (weak, nonatomic) IBOutlet UIButton *btnUpgradeToMultiAuthMode;
@property (weak, nonatomic) IBOutlet UIButton *btnGetOTPUsingBioFP;
