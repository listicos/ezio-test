 ...
 */
- (void)createTokenWithName:(NSString *)name provisioningConfiguration:(EMProvisioningConfiguration *)configuration completionHandler:(void (^)(id<EMCapToken>, NSError*))completionHandler;
...
/**
 ...
 @param completionHandler mandatory block to be invoked when error occurs or when token creation is completed.
 */
- (void)createTokenWithName:(NSString *)name provisioningConfiguration:(EMProvisioningConfiguration *)configuration deviceFingerprintTokenPolicy:(EMDeviceFingerprintTokenPolicy *)deviceFingerprintTokenPolicy completionHandler:(void (^)(id<EMCapToken>, NSError*))completionHandler;
